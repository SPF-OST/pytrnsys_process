...
class TestPlotters:
    ...
    def test_stacked_bar_chart_fig_and_ax(self, monthly_data):
        # Setup
        expected_file = (
            const.DATA_FOLDER / "plotters/stacked-bar-chart/expected.png"
        )
        ...
        # Execute
        _, _ = plot.stacked_bar_chart(
            monthly_data, columns, xlabel="", fig=fig, ax=ax
        )
        fig.savefig(actual_file)
    ...
    def test_create_line_plot_fig_and_ax(self, hourly_data):
        # Setup
        expected_fig = const.DATA_FOLDER / "plotters/line-plot/expected.png"
        actual_fig = const.DATA_FOLDER / "plotters/line-plot/actual.png"
        columns = ["QSrc1TIn", "QSrc1TOut"]
        ...
        fig, ax = get_fig_and_ax()
        # Execute
        _, _ = plot.line_plot(hourly_data, columns, xlabel="", fig=fig, ax=ax)
        fig.savefig(actual_fig)
    ...
    def test_bar_chart_fig_and_ax(self, monthly_data):
        # Setup
        expected_file = const.DATA_FOLDER / "plotters/bar-chart/expected.png"
        actual_file = const.DATA_FOLDER / "plotters/bar-chart/actual.png"
        columns = [
        ...
        # Execute
        _, _ = plot.bar_chart(monthly_data, columns, fig=fig, ax=ax)
        fig.savefig(actual_file)
    ...
    def test_histogram_fig_and_ax(self, hourly_data):
        # Setup
        expected_file = const.DATA_FOLDER / "plotters/histogram/expected.png"
        actual_file = const.DATA_FOLDER / "plotters/histogram/actual.png"
        columns = ["QSrc1TIn"]
        ...
        # Execute
        _, _ = plot.histogram(hourly_data, columns, ylabel="", fig=fig, ax=ax)
        fig.savefig(actual_file)
    ...
    def test_scatter_plot_too_many_columns_raises(self, monthly_data):
        with _pt.raises(ValueError):
            plotters.ScatterPlot().plot(
                monthly_data,
                columns=["QSnk60dQlossTess", "QSnk60dQ", "superfluous"],
            )
    ...
    def test_scatter_plot_with_provided_fig_and_ax(self, monthly_data):
        # Setup
        actual_file = (
            const.DATA_FOLDER / "plotters/scatter-plot/actual_color.png"
        )
    ...
    def test_scalar_compare_plot_groupby_color_only(self, comparison_data):
        # Setup
        actual = (
            const.DATA_FOLDER
    ...
    def test_scalar_compare_plot_groupby_marker_only(self, comparison_data):
        # Setup
        actual = (
            const.DATA_FOLDER
